...
|------|-----------|------------|----------|
| 1 | `Skill hlpm "..."` | `docs/vN/` 9 项产品交付物 | 否(必经) |
...
Agent:
  1. 加载 hlpm (27 步产品段)
     输出: docs/v1/ 下 9 项交付物 (prd.md / test-cases.md / 设计稿 HTML 等)
...
### 互补关系 (本技能编排的)
- **hlpm** → 产出 `docs/vN/` 9 项产品交付物
- **hldev** → 接手 `docs/vN/` 9 项交付物, 完成开发
