---
name: hlkb-intro
description: hlkb 技能说明(概览版)。5 分钟读懂"项目知识库"是什么、为什么需要、9 类怎么管。Use when 用户问"知识库是什么"/"hlkb 怎么用"/"为什么需要知识库"。
---
...
| 技能 | 触发 hlkb | 更新 | 对方已对接? |
|---|---|---|---|
| `hlpm` 版本交付自检 | 版本交付完成 | `docs/master-prd.md` / `master-test-cases.md` | ❌ 待对接 |
