...
- **完整目录规范**：详见 `hlpm/path-conventions.md`（中央规范文档，定义 15 项交付物路径、命名约定、深度限制、特殊情况处理）
...
> ℹ️ **交付物计数口径**(避免混淆):下面这份 **12 项**是"全流程完整交付清单"(单人 hl-flow 视角);`hlpm` 产品段交付 **9 项**(6 必出:PRD/测试/验收/非功能/矩阵/自检 + 3 条件出:设计/竞品/设计稿截图);`hldev` 视角"产品 9 + 开发 6 = **15 项**"。三个数字分属不同范围,不是矛盾。
