# docs/v1/ — hlpm 流程演示交付物包

> # ⚠️ 演示包 / NOT CURRENT VERSION ⚠️
>
> **此目录是 hlpm 流程的演示样例,非当前版本声明,非真实交付物。**
>
> 本包演示的需求是"为 SKILL.md 顶部加 v13 状态徽章",产出物按 hlpm 完整 23 步流程生成,**仅供了解 hlpm 各阶段产出物的结构/格式/写法**。
>
...
如需了解当前真实流程,请直接阅读 [`../SKILL.md`](../SKILL.md)(总入口)与 [`hlpm/SKILL.md`](../hlpm/SKILL.md)(产品段主流程)。